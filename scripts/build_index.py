...
用法:
    python build_index.py [--base "桌面\\YT影片文章"]
"""
...
from common import SRC_MAP, platform_label, resolve_base  # noqa: E402（P0-3 常數收斂）
...
/* 每日回顧入口（純連結膠囊，navy 底 gold 字，沿用既有色票） */
header.top .in{display:flex;align-items:center;gap:14px;flex-wrap:wrap}
header.top .in .hd{flex:1;min-width:220px}
.review-entry{flex:none;align-self:center;font-family:var(--font-sans);font-weight:800;font-size:14.5px;
  color:var(--gold);background:rgba(184,147,46,.14);border:1px solid var(--gold);border-radius:22px;
  padding:9px 18px;text-decoration:none;white-space:nowrap;transition:.15s;box-shadow:var(--shadow)}
.review-entry:hover{color:var(--navy);background:var(--gold);border-color:var(--gold)}
"""
...
<header class="top"><div class="in"><div class="hd"><h1>📚 我的影音知識庫</h1>
<div class="sub">由 YouTube 影片與 Podcast 精讀而成的知識分類庫</div></div>
<a class="review-entry" href="review.html">🧠 每日回顧</a></div></header>
<div class="wrap">
